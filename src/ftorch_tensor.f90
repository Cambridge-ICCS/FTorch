...
contains
  ...
  subroutine torch_tensor_backward_without_external_gradient(tensor)
    use, intrinsic :: iso_c_binding, only : c_bool
    type(torch_tensor), intent(in) :: tensor       !! Tensor to compute gradients of

    interface
      subroutine torch_tensor_backward_without_external_gradient_c(tensor_c) &
    ...
    call torch_tensor_backward_without_external_gradient_c(tensor%p)
