...
contains
  ...
  !> Evaluate MSELoss
  subroutine torch_loss_mse(input_tensor, target_tensor, loss_tensor, reduction_type)
    ...
    call torch_loss_mse_c(input_tensor%p, target_tensor%p, loss_tensor%p, reduction_type_value)
