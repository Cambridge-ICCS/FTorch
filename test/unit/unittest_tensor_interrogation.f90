...
contains
  ...
  ! Unit test for the torch_tensor_get_stride method of a 1D tensor
  @test(testparameters={get_parameters_short()})
  subroutine test_get_stride_1D(this)
    ...
    integer, parameter :: ndims = 1
    integer(kind=c_int64_t), parameter :: tensor_shape(ndims) = [6]
    integer(kind=c_int64_t), parameter :: expected_stride(ndims) = [1]

    ! Create a tensor with uninitialised values and check torch_tensor_get_stride can correctly
    ! identify its stride pattern
    call torch_tensor_empty(tensor, ndims, tensor_shape, dtype, device_type)
    @assertEqual(expected_stride, tensor%get_stride())

  end subroutine test_get_stride_1D

  ! Unit test for the torch_tensor_get_stride method of a 2D tensor
  @test(testparameters={get_parameters_short()})
  subroutine test_get_stride_2D(this)
    ...
    integer, parameter :: ndims = 2
    integer(kind=c_int64_t), parameter :: tensor_shape(ndims) = [2,3]
    integer(kind=c_int64_t), parameter :: expected_stride(ndims) = [3, 1]
  ...
  ! Unit test for the torch_tensor_get_stride method of a 3D tensor
  @test(testparameters={get_parameters_short()})
  subroutine test_get_stride_3D(this)
    ...
    integer, parameter :: ndims = 3
    integer(kind=c_int64_t), parameter :: tensor_shape(ndims) = [1,2,3]
    integer(kind=c_int64_t), parameter :: expected_stride(ndims) = [6, 3, 1]
